              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <input
                    ...
                    className="w-full max-w-full h-[46px] appearance-none px-4 py-2.5 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 focus:ring-2 focus:ring-indigo-500 text-zinc-900 dark:text-white"
                  />
                </div>
                <div className="flex-1 min-w-0">
